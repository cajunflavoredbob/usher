...
COPY _version.py seerr.py store.py radarr.py sonarr.py plex.py webhook.py webui.py settings.py http_util.py fix_result.py auth_util.py backup_crypto.py ./
COPY bot/ ./bot/
